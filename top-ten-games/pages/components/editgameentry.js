...
export default function EditGameEntry(id, name, reviewDescription, rank, gamePicture, onClose) {
  ...
  const handleSubmit = () => {
    ...
    // You can use the title, rating, and review state values
...
//This is to open the edit panel for the game to change properties.
