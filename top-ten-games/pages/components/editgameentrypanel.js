...
export default function EditGameEntryPanel({showModal, setShowModal},id, name, reviewDescription, rank, gamePicture, onClose) {
    //Toggle
                  ...
                  <p className="my-4 text-slate-500 text-lg leading-relaxed">
                    ...
                    won’t do anything. I was taught I could do everything.
                                ...
                                <div className="flex items-center">
                                    ...
                                    <input type="text" placeholder="Enter rank here"
